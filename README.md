...
| **17** | **Gerente**          | **Eliminar finca**               | Elimina una finca y borra asignaciones y tareas dependientes.                                             |
| **18** | **Gerente**          | **Crear contrato de trabajo**    | Registra un contrato con tipo, fechas, salario y tarifa por hora.                                         |
| **19** | **Gerente**          | **Editar contrato de trabajo**   | Modifica los datos de un contrato existente.                                                              |
| **20** | **Gerente**          | **Eliminar contrato de trabajo** | Elimina un contrato concreto del sistema.                                                                 |
| **21** | **Gerente**          | **Editar fichajes**              | Modifica fichajes de los empleados (horas de inicio/fin).                                                 |
| **22** | **Gerente**          | **Eliminar fichajes**            | Elimina un fichaje concreto del sistema.                                                                  |
| **23** | **Empleado**         | **Registrar fichaje inicio**     | Registra la hora de inicio de la jornada laboral.                                                         |
| **24** | **Empleado**         | **Registrar fichaje fin**        | Registra la hora de fin de la jornada laboral y cierra el fichaje.                                        |
| **25** | **Empleado**         | **Registrar tarea realizada**    | El empleado registra una tarea completada indicando tipo y duración.                                      |
